...
<head>
  ...
  <title>PROMAXVentas | Escritorio</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="escritorio.php" class="logo">
      ...
      <span class="logo-mini"><b>PRO</b> MAX</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>PRO</b> MAX</span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  Miguel Angel Villegas -Desarrollo de software
